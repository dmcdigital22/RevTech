...
class FooterWidgetFive extends Abstract_FooterWidget {
	...
	const COMPONENT_ID = 'footer-five-widgets';
	...
	public function init() {
		$this->set_property( 'label', __( 'Footer Five', 'neve' ) );
		$this->set_property( 'id', self::COMPONENT_ID );
		$this->set_property( 'width', 3 );
		$this->set_property( 'section', 'sidebar-widgets-footer-five-widgets' );
			...
			SettingsManager::get_instance()->add_controls_to_tabs(
				...
				array(
					SettingsManager::TAB_GENERAL => array(
						'sidebars_widgets-footer-five-widgets' => array(),
					),
				)
			);
		}
